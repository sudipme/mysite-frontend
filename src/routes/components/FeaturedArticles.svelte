...
<div class="max-w-[1400px] w-[90%] md:w-[75%] no-underline mt-10">
    <h1 class="text-3xl text-[#f5f5f7] font-raleway font-normal mb-4">
        Articles <a href="{base}/articles" class="text-lg ml-4 text-link"
            >( View All )</a
        >
    </h1>
</div>
...
<div
    class="max-w-[1400px] w-[90%] md:w-[75%] flex flex-col justify-between items-start overflow-hidden"
>
    <!-- featured blogs shadow, shadow-[0_100px_200px_10px_#fff] -->

    {#each featuredBlogs as blog (blog.time_stamp)}
        <a
            href="{base}/articles/{blog.blog_id}"
            class="no-underline cursor-pointer"
        >
            <div class="my-2.5 overflow-hidden cursor-pointer">
                <h2
                ...
                <h3
                    class="my-1 text-start font-sohne text-lg font-normal text-gray-400"
                >
